...
describe('getPlugIP', () => {
  ...
  it('should return IP for discovered plug', () => {
    _setDiscoveredPlugs({
      'bedroom-plug': { ip: '192.168.68.50', nickname: 'Bedroom Plug', model: 'P105' },
    });
  ...
  it('should handle multiple plugs', () => {
    _setDiscoveredPlugs({
      'plug-1': { ip: '192.168.68.50', nickname: 'Plug 1', model: 'P105' },
      'plug-2': { ip: '192.168.68.51', nickname: 'Plug 2', model: 'P105' },
      'plug-3': { ip: '192.168.68.52', nickname: 'Plug 3', model: 'P105' },
    });
...
describe('Discovery state management', () => {
  ...
  it('_setDiscoveredPlugs should set plugs', () => {
    _setDiscoveredPlugs({
      'test-plug': { ip: '192.168.68.100', nickname: 'Test Plug', model: 'P105' },
    });
  ...
  it('_setDiscoveredPlugs should replace existing plugs', () => {
    _setDiscoveredPlugs({
      'old-plug': { ip: '192.168.68.50', nickname: 'Old', model: 'P105' },
    });

    _setDiscoveredPlugs({
      'new-plug': { ip: '192.168.68.60', nickname: 'New', model: 'P105' },
    });
