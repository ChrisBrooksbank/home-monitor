...
const getEffectInProgress = (): boolean =>
    (getAppState()?.get('effect.inProgress') as boolean) || false;
 ...
 */
function isEffectInProgress(): boolean {
 ...
 */
async function redAlert(onComplete?: () => void): Promise<void> {
 ...
 */
async function partyMode(onComplete?: () => void): Promise<void> {
    return runLightEffect(
        'Party Mode',
        async lights => {
 ...
 */
async function discoMode(onComplete?: () => void): Promise<void> {
    return runLightEffect(
        'Disco',
        async lights => {
 ...
 */
async function waveEffect(onComplete?: () => void): Promise<void> {
    return runLightEffect(
        'Wave',
        async lights => {
            const lightIds = Object.keys(lights);
 ...
 */
async function sunsetMode(onComplete?: () => void): Promise<void> {
    return runLightEffect(
        'Sunset',
        async lights => {
