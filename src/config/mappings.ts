...
const lightMappings: Record<string, RoomName> = {
...
const motionSensorMappings: Record<string, string> = {
    'outdoor|outside|garden': 'Outdoor',
...
const lightPositions: Partial<Record<RoomName, { x: number; y: number }>> = {
