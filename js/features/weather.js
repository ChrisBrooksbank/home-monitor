...
const WEATHER_CONFIG = {
    apiKey: window.WEATHER_CONFIG?.API_KEY || '',
    location: window.WEATHER_CONFIG?.LOCATION || 'Chelmsford,UK'
};
 ...
 */
function updateWeatherElements(weatherData) {
 ...
 * @returns {string} - Category (clear, cloudy, rain, snow, fog, storm)
 */
