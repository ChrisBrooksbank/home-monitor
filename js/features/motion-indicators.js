...
(function() {
    ...
    function createPulseCircle() {
        ...
        circle.style.animation = 'pulse 1.5s ease-out infinite';
        return circle;
    }
     ...
     */
    function showMotionIndicator(room) {
     ...
     */
    function updateIndicators(motionSensors) {
