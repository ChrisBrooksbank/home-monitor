 ...
 * @returns {Promise<Object|null>} - Object with sunrise/sunset times or null
 */
 ...
 * @returns {string} - Period: 'night', 'dawn', 'day', or 'dusk'
 */
 ...
 * @returns {Object} - Sky configuration
 */
function getSkyConfig(period) {
    const configs = {
        dawn: {
            color1: '#FF6B6B', // Pink
