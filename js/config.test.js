...
describe('APP_CONFIG.proxies', () => {
    ...
    it('should have news proxy URL', () => {
        expect(APP_CONFIG.proxies.news).toBeDefined();
        expect(APP_CONFIG.proxies.news).toMatch(/^http:\/\/localhost:\d+$/);
    });
...
describe('APP_CONFIG.intervals', () => {
    ...
    it('should have positive tapoDiscovery interval', () => {
        expect(APP_CONFIG.intervals.tapoDiscovery).toBeGreaterThan(0);
    });
